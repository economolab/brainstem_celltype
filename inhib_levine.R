...
combined_inhib<- readRDS('levine_new/inhib_integrate1.rds')

DefaultAssay(combined_inhib) <- "integrated"

combined_inhib <- ScaleData(combined_inhib, verbose = FALSE)
combined_inhib <- RunPCA(combined_inhib, verbose = FALSE)
